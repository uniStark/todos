                              ...
                              <AnimatePresence>
                                {openMenuId === todo.id && (
                                  <>
                                    ...
                                    >
                                      <div className="glass-card p-3 rounded-2xl shadow-2xl ring-1 ring-black/5 dark:ring-white/10 flex flex-col gap-2">
