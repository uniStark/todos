export const translations = {
  zh: {
    ...
    loginTitle: '登录',
    registerTitle: '注册账号',
    loginDescription: '登录以访问你的任务',
    registerDescription: '注册以开始管理你的任务',
  ...
  en: {
    ...
    loginDescription: 'Sign in to access your tasks',
    registerDescription: 'Register to start managing your tasks',
    ...
    todoCompletedToast: 'Task completed 🎉',
